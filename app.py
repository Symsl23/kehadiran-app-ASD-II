...
with tab2:
    ...
    # Add this: Initialize control flag if not already set
    ...
    if face_img and face_img != st.session_state.get("last_capture"):
        # Reset control flag to allow processing
        st.session_state.attendance_submitted = False
        st.session_state.last_capture = face_img

    # Submit only if we haven't already submitted this capture
    if face_img and not st.session_state.attendance_submitted:
        ...
        if not encodings:
            ...
            if min_distance < 0.45:
                ...
                st.session_state.attendance_submitted = True  # Mark as submitted
